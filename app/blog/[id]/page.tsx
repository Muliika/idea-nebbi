        ...
        <div className="relative px-6 lg:px-8">
          <div className="mx-auto max-w-prose text-lg">
            <h1>
              ...
              <span className="mt-2 block text-center text-3xl font-bold leading-8 tracking-tight text-black sm:text-4xl dark:text-white">
                Odio penatibus risus viverra tellus varius sit neque erat velit.
              </span>
            </h1>
          ...
          <div className="prose prose-lg prose-indigo mx-auto mt-6 text-black dark:text-white">
            <p>
              Faucibus commodo massa rhoncus, volutpat. Mattis mauris semper sed amet vitae sed
              turpis id. Id dolor praesent donec est. Odio penatibus risus viverra tellus varius sit
              neque erat velit. Faucibus commodo massa rhoncus, volutpat. Dignissim sed eget risus
              enim.{" "}
            ...
            <figure>
              ...
              />
              <figcaption>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Necessitatibus, culpa?
              </figcaption>
            </figure>
            ...
            <p>
              ...
              Tincidunt sed tempus ut viverra ridiculus non molestie. Gravida quis fringilla amet
              eget dui tempor dignissim. Facilisis auctor venenatis varius nunc, congue erat ac.
            ...
            <div className="md:flex">
              <div className="p-6">
                ...
                <p className="text-gray-600 mb-4">
                  ...
                  unde. Sed exercitationem placeat consectetur nulla deserunt vel iusto .
                </p>
              ...
              <form action="#" className="relative">
                <div className="overflow-hidden rounded-lg border border-gray-300 shadow-sm focus-within:border-white focus-within:ring-1 focus-within:ring-white">
                  ...
                  <textarea
                    ...
                    name="comment"
                    id="comment"
                    className="block w-full resize-none bg-transparent border-0 py-3 focus:ring-0 sm:text-sm"
                ...
                <div className="absolute inset-x-0 bottom-0 flex justify-between py-2 pl-3 pr-2">
                  ...
                  <div className="flex-shrink-0">
                    <button
                      type="submit"
                      className="inline-flex items-center rounded-md border border-transparent bg-black dark:bg-gray-500 px-4 py-2 text-sm font-medium text-white shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2"
                    >
                      Post
                    </button>
                  </div>
