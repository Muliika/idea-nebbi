    ...
    <div className="max-w-3xl mx-auto p-5 mb-16">
      ...
      <div className="">
        ...
        <section aria-labelledby="filter-heading" className="grid items-center border-t">
          ...
          <div className="relative col-start-1 row-start-1 py-4">
            <div className="mx-auto flex space-x-6 divide-x divide-gray-200 px-4 text-sm sm:px-6 lg:px-8">
              <div>
                <button
                  type="button"
                  className="group flex items-center font-medium text-black dark:text-white"
          ...
          <div
            className={`border-t border-gray-200 py-10" id="disclosure-1 ${
              filter
                ? "transition ease-out duration-100 transform opacity-100 scale-100 bg-white"
                  ...
                  <div className="space-y-6 pt-6 sm:space-y-4 sm:pt-4">
                    <div className="flex items-center text-base sm:text-sm">
                      <input
                        ...
                        type="checkbox"
                        className="h-4 w-4 flex-shrink-0 rounded border-gray-300 text-black focus:ring-black"
                      />
                      <label htmlFor="category-0" className="ml-3 min-w-0 flex-1 text-gray-600">
                        Personal
                      </label>
                    </div>
                    ...
                    <div className="flex items-center text-base sm:text-sm">
                      <input
                        ...
                        className="h-4 w-4 flex-shrink-0 rounded border-gray-300 text-black focus:ring-black"
                      />
                      <label htmlFor="category-1" className="ml-3 min-w-0 flex-1 text-gray-600">
                        Urban Living
                      </label>
                    </div>
                    ...
                    <div className="flex items-center text-base sm:text-sm">
                      <input
                        ...
                        className="h-4 w-4 flex-shrink-0 rounded border-gray-300 text-black focus:ring-black"
                      />
                      <label htmlFor="category-2" className="ml-3 min-w-0 flex-1 text-gray-600">
                        Fashion
                      </label>
                    </div>
                    ...
                    <div className="flex items-center text-base sm:text-sm">
                      <input
                        ...
                        className="h-4 w-4 flex-shrink-0 rounded border-gray-300 text-black focus:ring-black"
                      />
                      <label htmlFor="category-3" className="ml-3 min-w-0 flex-1 text-gray-600">
                        Banter
                      </label>
                    </div>
                  </div>
            ...
            <div className="mx-auto flex max-w-7xl justify-end px-4 sm:px-6 lg:px-8">
              <div className="relative inline-block">
                <div className="flex">
                  <button
                    type="button"
                    className="group inline-flex justify-center text-sm font-medium text-black dark:text-white"
                    id="menu-button"
                    aria-expanded="false"
                    aria-haspopup="true"
